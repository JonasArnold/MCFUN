...
void ftm0Init(void)
{
  // todo #7.3-01 set clockgating for FTM0
  SIM->SCGC6 |= SIM_SCGC6_FTM0_MASK;

  // todo #7.3-02 configure the timer with "Fixed frequency clock" as clocksource and with a "Prescaler" of 1 => 250 kHz
  FTM0->SC = FTM_SC_CLKS(2) | FTM_SC_PS(0);

  // todo #7.3-03 Enable FTM0 interrupt on NVIC with Prio: PRIO_FTM0 (defined in platform.h)
